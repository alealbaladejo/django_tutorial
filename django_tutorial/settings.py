...
ALLOWED_HOSTS = ['172.22.203.143', 'django.alejandro.org']
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Esto coloca los archivos estáticos recopilados en un directorio 'staticfiles'
